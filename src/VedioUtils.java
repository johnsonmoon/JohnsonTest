...
public class VedioUtils {
     ...
     */
    public static boolean convertVedio(String ffmpegCommandPathName, String vedioPathName, String vedioDestinationPathName){
     ...
     * @return true成功, false失败
     */
    public static boolean cutoutVedio(String ffmpegCommandPathName, String vedioPathName, String imageDestinationPathName, float cutTime){
        File file = new File(vedioPathName);
        if(!file.exists()){
            return false;
        }
