...
public class HTTPconnectionTest {
	...
	public static void testDeleteMyCourse() {
		...
		System.out.println(
				httpUtil.singleFileUploadWithParameters(BASE_URL_COURSES, uploadFile, MIME_FileType.Video_mp4, params2));
	...
	public static void testCourseVedioUploading() {
		...
		System.out.println(
				httpUtil.singleFileUploadWithParameters(BASE_URL_COURSES, uploadFile2, MIME_FileType.Video_mp4, params4));
		...
		downUtil.downloadByGet(downloadPath + "2photoThumbnail.jpg",
				BASE_URL_COURSES + "?action=getThumbnailPhotoById&Photo_ID=" + Photo_ID);
